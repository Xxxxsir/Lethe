...
def get_accelerate_model(args, checkpoint_dir):
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        ...
        trust_remote_code=args.trust_remote_code,
        use_auth_token='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',
    )
    ...
    def load_data(dataset_name, args = args):
        ...
        if  dataset_name == 'sst2':
            ...
            full_dataset=load_dataset("json", data_files={'train': DATA_PATH + '/sst2/converted_train.json', 'val': DATA_PATH + '/sst2/converted_dev.json', \
                'test': DATA_PATH + '/sst2/converted_test.json'}, cache_dir = args.cache_dir,split=dataset_ratios)
            ...
            }, cache_dir=args.cache_dir,split=dataset_ratios)
...
def train():
    ...
    if args.resume_path:
        ...
        print("生 Checkpoint path: {}".format(resume_path))
    ...
    if args.do_mmlu_eval:
        ...
        class MMLUEvalCallback(transformers.TrainerCallback):
            def on_evaluate(self, args, state, control, model, **kwargs):
                ...
                print("徴 len(subject): {}, len(preds): {}, len(refs): {}".format(len(subject), len(preds), len(refs)))
    ...
    if args.do_predict:
        ...
        print("脂 Test accuracy: {:.2f}%".format(test_acc * 100))
